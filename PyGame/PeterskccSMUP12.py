#kccSMUP_12/13
#DO NOT FORGET TO ADD SOUND 
#DID NOT FINSH VIDEO BEFORE BREAK
import pygame
import random
...
def newmob():
        ...
        all_sprites.add(m)
        mobs.add(m)
def draw_shield_bar(screen,x,y,percent):
        if percent<0:
           percent=0
        BAR_LENGTH = 100
        BAR_HEIGHT = 10
...
player_mini_image = pygame.image.load('playerShip1_orange.png').convert()
player_mini_image = pygame.transform.scale(player_mini_image, (25,19))
player_mini_image.set_colorkey(BLACK)
background_rect = background.get_rect()
meteor_images = []
meteor_list = ['meteorBrown_big1.png', 'meteorBrown_med1.png', 'meteorBrown_med3.png',
               'meteorGrey_med2.png', 'meteorBrown_small1.png', 'meteorBrown_small2.png',
...
#load all sounds
shoot_sound = pygame.mixer.Sound('sfx_laser1.wav')
shield_sound = pygame.mixer.Sound('Rise01.wav')
power_sound =  pygame.mixer.Sound('Rise02.wav')
expl_sounds = []
...
pygame.mixer.music.load('Space Music.wav')
